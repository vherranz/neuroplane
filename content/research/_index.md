...
title: Research
date: 2026-03-18
# Se renderiza con layouts/research/list.html (diseño institucional, 2 columnas).
intro: |
...
programme:
  - n: "01"
    title: Human brain development and progenitor dynamics
    subtitle: Understanding how cellular diversity emerges in the human brain
    keywords: Ganglionic eminences · Radial glia · Migration
    body: |
  ...
  - n: "02"
    title: Immature neurons, prolonged maturation, and brain plasticity
    subtitle: How delayed maturation may support long-term plasticity
    keywords: DCX+ populations · Plasticity · Vulnerability
    body: |
  ...
  - n: "03"
    title: Comparative organization of the paralaminar amygdala
    subtitle: A model system for late-maturing neurons
    keywords: Comparative · Smooth vs folded brains
    body: |
...
<div class="funding-logos">
  <a href="https://www.gva.es" target="_blank" rel="noopener">
    <img class="funding-logo funding-logo-gva" src="/media/GVA.png" alt="Generalitat Valenciana">
  </a>
  <a href="https://www.ciencia.gob.es" target="_blank" rel="noopener">
    <img class="funding-logo funding-logo-micinu" src="/media/MICINU.png" alt="Ministry of Science, Innovation and Universities">
  </a>
  <a href="https://www.uv.es" target="_blank" rel="noopener">
    <img class="funding-logo funding-logo-uv" src="/media/Logo UV.png" alt="Universitat de València">
  </a>
</div>
